...
import br.com.raniel.viagens.util.DataUtil;
...
public class ResumoCompraActivity extends AppCompatActivity {
    ...
    private void mostraPreco(Pacote pacote) {
        ...
        String moedaBraileira = MoedaUtil.formataParaBrasileiro(pacote.getPreco());
    ...
    private void mostraImagem(Pacote pacote) {
        ...
        Drawable drawableDaImagem = ResourceUtil.devolveDrawable(this, pacote.getImagem());
