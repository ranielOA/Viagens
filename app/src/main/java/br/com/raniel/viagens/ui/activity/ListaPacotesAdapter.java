...
class ListaPacotesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int idDrawableDaImagem = resources.getIdentifier(pacote.getImagem(), "drawable", context.getPackageName());
        Drawable drawableDaImagem = resources.getDrawable(idDrawableDaImagem);
